...
expName = 'Tutorial 4 Motor sequence learning'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Dell\\Desktop\\Tutorial 4 Motor sequence learning.py',
...
# --- Initialize components for Routine "trialii" ---
...
for thisTrial in trials:
    ...
    # --- Prepare to start Routine "trialii" ---
    ...
    trialiiComponents = [fixation, line1, line2, line3, line4, probe, key_resp]
    for thisComponent in trialiiComponents:
    ...
    # the Routine "trialii" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    thisExp.nextEntry()
