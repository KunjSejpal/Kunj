...
expName = 'Tutorial 3 visual search experiment'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Dell\\Desktop\\Tutorial 3 visual search experiment_lastrun.py',
