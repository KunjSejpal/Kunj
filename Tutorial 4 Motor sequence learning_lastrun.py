...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Dell\\Desktop\\Tutorial 4 Motor sequence learning_lastrun.py',
...
trials = data.TrialHandler(nReps=24.0, method='fullRandom', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('con_sequence.csv'),
